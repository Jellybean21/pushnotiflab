...
const app = (() => {
  ...
  // TODO 2.2 - request permission to show notifications, this will show up a pop to ask user if want allow notifications
    ...
    if(Notification.permission == 'granted') {
      navigator.serviceWorker.getRegistration().then(reg => {
          ...
          const options = {
            ...
            // 2.5 add actions to the notification
            actions: [
            ...
            // TODO 5.1 add a tag to the notifications
            //tag: 'id1' // tag allow notification to replace themselves if they are received too fast in a row
          }
          reg.showNotification('Notification has arrived', options);
      });
  ...
  const applicationServerPublicKey = 'BK1jkSwGpNhSyPIeAdiB9EwB4NA6FQdI9kBf7nRmwCs34e1z1BvEeXT5XUJ9AK6VT1XxkGAufxiezPCzhDtO4qI';
